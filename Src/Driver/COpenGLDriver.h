...
namespace video
{
	...
	public:
		...
		virtual void draw3dLine(f32 x1,f32 y1,f32 z1,f32 x2,f32 y2,f32 z2);
		...
		virtual void drawImage(f32* imageData,s32 width,s32 height,const core::rect<s32>& rectangle);
